...
export const Header: FC = () => {
  ...
  const starsUrl = `${baseUrl}/github/stars/tarnadas/smmdb-lib?style=for-the-badge&link=https://github.com/Tarnadas/smmdb-lib&link=https://github.com/Tarnadas/smmdb-lib/stargazers`;
  const cratesUrl = `${baseUrl}/crates/v/smmdb?style=for-the-badge&link=https://crates.io/crates/smmdb`;
  const npmUrl = `${baseUrl}/npm/v/smmdb?style=for-the-badge&link=https://www.npmjs.com/package/smmdb`;
