...
var _morton = require("morton");

var _morton2 = _interopRequireDefault(_morton);
...
class Image {
    ...
    async from3DS() {
        this.buffer3DS = Buffer.concat([Buffer.from(`42 4D 0A 1C 01 00 00 00 00 00 8A 00 00 00 7C 00 
        ...
        this.buffer3DS = Buffer.concat([Buffer.from(`42 4D 8A 3C 00 00 00 00 00 00 8A 00 00 00 7C 00 
