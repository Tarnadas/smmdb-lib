...
const IMAGE_BUFFER = Buffer.concat([Buffer.from(`42 4D 0A 1C 01 00 00 00 00 00 8A 00 00 00 7C 00 
...
const IMAGE_BUFFER_WIDE = Buffer.concat([Buffer.from(`42 4D 8A 3C 00 00 00 00 00 00 8A 00 00 00 7C 00 
        ...
        00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
        00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 
        00 00 00 00 00 00 00 00 00 00`.replace(/\s+/g, ''), 'hex')], 0x3C8A);
