...
class Course {
    ...
    loadTnl() {
        ...
        return [new _tnl.Tnl(this[coursePath] + "/thumbnail0.tnl").data, new _tnl.Tnl(this[coursePath] + "/thumbnail1.tnl").data];
    }
    ...
    async setThumbnail(pathToThumbnail) {
        ...
        this.thumbnail = await this[tnl].toJpeg();
        this[tnlPreview] = new _tnl.Tnl((await jpeg.toTnl(false)));
        this.thumbnailPreview = await this[tnlPreview].toJpeg();
        return null;
    }
