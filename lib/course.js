...
class Course {
    ...
    async to3DS() {
        ...
        this.changeEndian();
        let res = Buffer.concat([Buffer.from('00000000043004007D000000DDBAFECA3BA0B2B86E55298B00C01000', 'hex'), this[courseData], this[courseDataSub], Buffer.alloc(0x40), await new _tnl.Image(this.thumbnailPreview, this.thumbnail).to3DS(), Buffer.alloc(0x3800)]);
