...
class Course {
    ...
    to3DS() {
        ...
        let res = Buffer.concat([Buffer.from('00000000043004007D000000DDBAFECA3BA0B2B86E55298B00C01000', 'hex'), this[courseData], this[courseDataSub], Buffer.alloc(0x157C0), Buffer.alloc(0x3840)]);
        this.setHeader(res);
        return res;
    }
