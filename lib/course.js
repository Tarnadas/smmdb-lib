...
class Course {
    ...
    loadTnl() {
        ...
        return [new _tnl2.default(this[coursePath] + "/thumbnail0.tnl"), new _tnl2.default(this[coursePath] + "/thumbnail1.tnl")];
    }
    ...
    async setThumbnail(pathToThumbnail) {
        ...
        let jpeg = new _tnl2.default(path.resolve(pathToThumbnail));
        return await _bluebird2.default.all([new _bluebird2.default(async resolve => {
